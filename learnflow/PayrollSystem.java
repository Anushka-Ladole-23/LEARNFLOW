...
public class PayrollSystem {
    ...
    public static void main(String[] args) {
        ...
        system.addEmployee(new Employee(1, "Jane Smith", 3500, 12));
        system.addEmployee(new Employee(1, "Alice Johnson", 4000, 15));
        system.addEmployee(new Employee(4, "Johny Derp",3000, 10));
        system.addEmployee(new Employee(5, "Samrina Loze",5000, 18));
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    System.out.print("Enter the assigned Team Name : ");
